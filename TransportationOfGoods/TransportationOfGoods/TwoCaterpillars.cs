...
namespace TransportationOfGoods
{
    abstract class TwoCaterpillars : Driving
    {
        ...
        public TwoCaterpillars(double loadCapacity, double maxDistance, double weightTransport, double power, double weightTransportWithParcel, double frictionCoefficient)
